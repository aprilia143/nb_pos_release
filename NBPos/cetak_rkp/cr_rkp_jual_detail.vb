...
Public Class cr_rkp_jual_detail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS.cr_rkp_jual_detail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_rkp_jual_detail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_rkp_jual_detail = New cr_rkp_jual_detail()
        rpt.Site = Me.Site
        Return rpt
    End Function
